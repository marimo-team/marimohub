		...
		nav: [
			{
				...
				activeMatch: '^/(getting-started|deployment-options|testing-locally|architecture)',
			},
			{
				text: 'Backends',
				activeMatch: '^/(auth|storage|compute|sandbox-image)',
				items: [
					{ text: 'Auth', link: '/auth' },
			...
			{
				text: 'Capabilities',
				activeMatch: '^/(ai|syncing|coreweave-bucket-access)',
				items: [
					{ text: 'Managed AI', link: '/ai' },
					{ text: 'Syncing from external sources', link: '/syncing' },
					{ text: 'CoreWeave bucket access', link: '/coreweave-bucket-access' },
				],
			},
			{ text: 'Deploy', link: '/deploying/', activeMatch: '^/deploying/' },
			{
				text: 'Reference',
				activeMatch: '^/(configuration|api)',
				items: [
