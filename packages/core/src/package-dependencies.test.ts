...
const ADAPTER_PATTERN =
	/^@marimo-hub\/(?:(?:storage|compute|auth|credentials|secrets|notify|object-browser|database-browser|source-control)-|duckdb-wasm-runtime$|postgres-runtime$|notebook-bridge$)/;
