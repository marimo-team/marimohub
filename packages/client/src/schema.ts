...
export interface paths {
	...
	'/api/cli/v1/device-authorizations': {
		 ...
		 * @description Returns a high-entropy device code that is bound to the PKCE challenge. Also returns a short code for browser approval.
		 */
		post: operations['auth.cli.device.request'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/cli/v1/device-token': {
		 ...
		 * @description Returns 202 while browser approval is pending. Returns a new personal access token once after approval.
		 */
		post: operations['auth.cli.device.poll'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/cli/v1/token': {
		 ...
		 * @description Public PKCE exchange for loopback login. The code is short-lived and single-use. Exchange also requires the verifier held by the CLI.
		 */
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/files': {
		...
		/** Read raw workspace file content */
		get: operations['notebooks.workspace.files.read'];
		/** Create or overwrite a workspace file */
		put: operations['notebooks.workspace.files.write'];
		post?: never;
		delete?: never;
		options?: never;
		head?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/access': {
		...
		/** Get workspace file capabilities */
		get: operations['notebooks.workspace.access'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/entries': {
		...
		get: operations['notebooks.workspace.list'];
		put?: never;
		post?: never;
		/** Delete a workspace entry */
		delete: operations['notebooks.workspace.delete'];
		options?: never;
		head?: never;
		patch?: never;
		trace?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/search': {
		...
		get: operations['notebooks.workspace.search'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/directories': {
		...
		post: operations['notebooks.workspace.directories.create'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/move': {
		...
		get?: never;
		put?: never;
		/** Move a workspace entry */
		post: operations['notebooks.workspace.move'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/workspace/copy': {
		...
		get?: never;
		put?: never;
		/** Copy a workspace entry */
		post: operations['notebooks.workspace.copy'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/v1/projects/{pid}/thumbnails': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		/** List visible notebook thumbnails */
		get: operations['projects.thumbnails'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/projects/{pid}/notebooks/{nid}/thumbnail': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		get: operations['notebooks.thumbnail'];
		/** Upload a custom cropped thumbnail */
		put: operations['notebooks.thumbnail.set'];
		post?: never;
		/** Remove the custom thumbnail */
		delete: operations['notebooks.thumbnail.remove'];
		options?: never;
		head?: never;
		patch?: never;
		trace?: never;
	};
	'/api/v1/projects/{pid}/notebooks/{nid}/thumbnail/image': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		/** Read the selected thumbnail */
		get: operations['notebooks.thumbnail.image'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/users': {
		 ...
		 * @description Batch-resolve opaque user ids (the auth `sub` stored as a notebook `author` or session `user_id`) into `{ id, email, name, picture_url }`. Ids with no recorded identity are omitted from the result map. Resolving other users requires the same directory authority as user search; authenticated callers may resolve themselves.
		 */
	...
	'/api/v1/me/cli-authorizations': {
		...
		/**
		 * Approve a CLI login
		 * @description Creates a one-time code that is bound to the CLI PKCE challenge. Requires a browser session. Exchange creates the personal access token.
		 */
	...
	'/api/v1/me/oauth-authorizations/{id}': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		get: operations['auth.oauth.preview'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/me/oauth-authorizations/{id}/approve': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		get?: never;
		put?: never;
		post: operations['auth.oauth.approve'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/v1/me/oauth-authorizations/{id}/deny': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		get?: never;
		put?: never;
		post: operations['auth.oauth.deny'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
...
export interface components {
	schemas: {
		...
		WorkspaceAccess: {
			writable: boolean;
			/** @enum {string|null} */
			read_only_reason: 'git_source' | 'viewer' | 'active_session' | null;
			protected_paths: {
				path: string;
				denied_operations: ('create' | 'write' | 'move' | 'copy' | 'delete')[];
			}[];
		};
		NotebookPage: {
...
export interface operations {
	...
	'notebooks.workspace.files.read': {
		parameters: {
			query: {
				path: string;
			};
	...
	'notebooks.workspace.files.write': {
		parameters: {
			query: {
				path: string;
				create?: 'true' | 'false';
			...
			200: {
				...
				content: {
					'application/json': {
						/** @enum {boolean} */
						success: true;
						data: components['schemas']['WorkspaceAccess'];
					};
				};
			};
			/** @description Authentication required */
	...
	'notebooks.workspace.directories.create': {
		parameters: {
			query?: never;
			header?: never;
			path: {
	...
	'projects.thumbnails': {
		...
		requestBody?: never;
		responses: {
			/** @description Thumbnail metadata by notebook ID */
			200: {
				headers: {
					[name: string]: unknown;
				};
