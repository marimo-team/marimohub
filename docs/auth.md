...
It is the one grant that overrides the per-project role model. Super admins are
also the only principals who can manage
[org-wide integrations](./integrations.md#org-wide-integrations) — no project
role reaches those.
