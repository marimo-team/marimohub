...
| `MARIMOHUB_APP_MAX_SESSIONS_PER_VERSION` | Maximum current-version sandboxes per notebook. Draining versions do not count. Project and starter-user caps still apply. | — | — | — |
