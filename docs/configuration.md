...
| `MARIMOHUB_DATA_PREVIEW_IMAGE` | Image for sandbox previews. It must contain Python, PyIceberg, and PyArrow. The compute backend must support image overrides. The hub verifies the image at startup. | — | — | `ghcr.io/example/marimohub-data-preview:1` |
