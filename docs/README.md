...
- [Session surfaces](./surfaces.md) - open VS Code or OpenCode in an editor sandbox.
...
- [API tokens](./api-tokens.md) - grant automation access to selected actions and projects.
- [MCP server](./mcp.md) - connect an agent through OAuth or a personal access token.
