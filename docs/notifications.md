...
- The server's generic-webhook transport permits one request retry. HTTP 429 honors
  `Retry-After`, clamped to 1–60 seconds. Other retryable failures retry immediately.
