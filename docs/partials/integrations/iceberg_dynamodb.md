...
| `region` | string |  |  |  |
| `credentials.method` | `ambient`, `static`, `profile` |  | `ambient` | DynamoDB Catalog credentials only. When explicit, these override unified credentials for DynamoDB calls. |
