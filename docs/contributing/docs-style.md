...
- Use a `<figure class="doc-screenshot">` with descriptive image alt text.
- Add a short `<figcaption>` unless the surrounding heading, description, and alt text already explain the screenshot.
